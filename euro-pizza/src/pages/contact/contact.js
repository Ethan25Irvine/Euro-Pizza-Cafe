        ...
        <div className="container bg-light pb-3 my-5">
            ...
            <div className="row text-center">
                ...
                <div className="row text-center justify-content-center">
                    <h1 className="icon col-lg-1 col-md-1 col-sm-1 col-1" ><a className="text-dark" href="https://www.facebook.com/europizzacafe?fref=ts" target="_blank"><i class="fab fa-facebook-f"></i></a></h1>
                    <h1 className="icon col-lg-1 col-md-1 col-sm-1 col-1 "><a className="text-dark" href="https://www.instagram.com/europizzacafe/" target="_blank"><i class="fab fa-instagram"></i></a></h1>
                    <h1 className="icon col-lg-1 col-md-1 col-sm-1 col-1"><a className="text-dark" href="https://www.yelp.com/biz/euro-pizza-cafe-fountain-hills" target="_blank"><i class="fab fa-yelp"></i></a></h1>
